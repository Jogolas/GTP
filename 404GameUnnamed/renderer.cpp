...
SDL_Window * Renderer::createWindow(SDL_Window * window, SDL_GLContext &context) //pass in a window so the window can be
{																				//initialised in one place and called upon again to use in other
	{																		    //commands like full screen and resizing
		...
		window = SDL_CreateWindow("this is da gam", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN);
